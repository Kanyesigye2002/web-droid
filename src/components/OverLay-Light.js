      ...
      <svg xmlns='http://www.w3.org/2000/svg' width='1440' height='1024' viewBox='0 0 1440 1024'>
        <defs>
          <radialGradient id='radial-gradient' cx='0.143' cy='1.115' r='1.095' gradientTransform='matrix(0.289, -0.913, -0.65, -0.407, 0.915, 1.516)' gradientUnits='objectBoundingBox'>
            <stop offset='0' stop-color={PRIMARY_LIGHT} stop-opacity='0.4' />
            <stop offset='0.499' stop-color={PRIMARY_MAIN} stop-opacity='0.5' />
            <stop offset='1' stop-color={PRIMARY_DARK} stop-opacity='0.7' />
          </radialGradient>
          <radialGradient id='radial-gradient2' cx='0.143' cy='1.115' r='1.095' gradientTransform='matrix(0.289, -0.913, -0.65, -0.407, 0.915, 1.516)' gradientUnits='objectBoundingBox'>
