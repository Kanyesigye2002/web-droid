...
// sections
import { CalendarForm, CalendarStyle, CalendarToolbar } from '../../sections/calendar';
...
export default function Calendar() {
  ...
  return (
    <Page title="Calendar">
      <Container maxWidth={themeStretch ? false : 'xl'} sx={{pt: '96px'}}>
        <HeaderBreadcrumbs
          heading="Calendar"
          links={[{ name: 'User', href: '/user/account' }, { name: 'Calendar' }]}
          action={
            <Button
              variant="contained"
